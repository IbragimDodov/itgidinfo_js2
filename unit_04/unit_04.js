...
function f8() {
    ...
    let newdiv = '<div class="js2">new div</div>';
    out8.innerHTML += newdiv;
}
...
function f13() {
    ...
    // out13.innerHTML = i13.oninput.value;

    // i13.oninput = out13.innerHTML = out13.value;
}
...
function f18() {
    ...
    // console.log(document.querySelector('.i-18').value);
    i18.value = s18;
}
...
function f19() {
    ...
    // console.log(out19.innerHTML);`
    // console.log(i19.value);

    i19.value = out19.innerHTML;
}
