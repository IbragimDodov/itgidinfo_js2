...
let ar1 = ['stroke', 17, true, false, 'color'];
...
let ar2 = ['stroke', 17, true, false, 'color'];
...
let ar3 = [1, 3, 5, 'stroke', 'wtf', 'juice', 'apelcin'];
...
// Task 4
//Создайте массив .4. Выведите нулевой, третий, восьмой элемент массива в out-4 через пробел.
...
let ar9 = [100, 200, 300, 400, 700, 54, 38, 40, 'wow'];
...
function f16() {
    ...
    out16odd.innerHTML = strodd;
    out16even.innerHTML = streven;
}
...
let ar19 = [15, 424, 10, 313, 78, 241, 4, 45, 67, 3];
...
function f19() {
    ...
    console.log(ar19.indexOf(min));
    document.querySelector('.out-19').innerHTML = ar19.indexOf(min);
}
