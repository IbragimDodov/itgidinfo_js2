...
function t12() {
    ...
    out12.innerHTML ='Hello' + " " + i121.value + ' ' + i122.value;
}
...
function t19() {
    ...
    out19.innerHTML = Number(a) + Number(b);
}
...
b8.onclick = function() {
    document.querySelector('.out-8').innerHTML = I8.value;
    I8.value = '';
}
